...
- Updated dependencies [cadf144]
  ...
  - @milaboratories/ptabler-expression-js@1.2.41
...
- Updated dependencies [e8f26d6]
  ...
  - @milaboratories/ptabler-expression-js@1.2.39
...
- Updated dependencies [80a9963]
  ...
  - @milaboratories/ptabler-expression-js@1.2.38
...
- 62c1418: Name the column predicates after what a caller can do, not after the recipe classes
  ...
  **Removed.**
  ...
  - `getLeafColumnData` — it walked past an axis-filtered layer and returned the
    underlying leaf's _unsliced_ data, inconsistent with the recipe's spec;
...
- Updated dependencies [98092a6]
  ...
  - @milaboratories/ptabler-expression-js@1.2.26
...
- Updated dependencies [5becf87]
  ...
  - @milaboratories/ptabler-expression-js@1.2.4
