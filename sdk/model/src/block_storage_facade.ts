...
export interface BlockStorageFacadeV2 {
  ...
  ) => { error: string } | { error?: undefined; newStorageJson: string; info: string; warn?: string };
   ...
   */
  [BlockStorageFacadeV2Callbacks.DataUpgrade]: (
    versioned: { version: string; data: unknown },
  ) => { version: string; data: unknown; warning?: string };
