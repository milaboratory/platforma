...
import {
  deriveLabels as deriveLabelsInternal,
...
/** @deprecated Use the version of deriveLabels that accepts SpecExtractorResult directly. */
export function deriveLabels<T>(
  ...
  const labeled = deriveLabelsInternal(specs, options);
