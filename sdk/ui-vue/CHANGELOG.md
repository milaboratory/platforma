...
- Updated dependencies [e8f26d6]
  ...
  - @milaboratories/uikit@2.15.30

## 1.83.13

### Patch Changes

- Updated dependencies [b659a5d]
  - @milaboratories/uikit@2.15.29
...
- 5070b32: Keep the default `sorting` passed to `createPlDataTableV3` alive
...
- Updated dependencies [da11734]
  ...
  - @milaboratories/uikit@2.15.21

## 1.80.15

### Patch Changes

- Updated dependencies [462418f]
  - @milaboratories/uikit@2.15.20

## 1.80.13

### Patch Changes

- 597ca40: PlDataTable: allow the default filter group to be fully cleared, and harden filter merging.
...
- 92db3a0: PlTableFiltersV2: derive column option labels with `deriveDistinctLabels`
...
- f0b5537: Fix an infinite grid-remount loop in `PlAgDataTableV2` that made the column
...
- Updated dependencies [09a2985]
- Updated dependencies [a6de7cb]
