...
import { useMouseCapture } from "../composition/useMouseCapture.ts";
import { tapIf } from "../helpers/functions.ts";
import { clamp } from "../helpers/math.ts";
import { PlTooltip } from "./PlTooltip/index.ts";
import type { SliderMode } from "../types.ts";
import InputRange from "./InputRange.vue";
import { useSliderBreakpoints } from "../composition/useSliderBreakpoints.ts";
