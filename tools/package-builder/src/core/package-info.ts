...
export type BuildablePackage = RunEnvironmentPackage | BinaryPackage | JavaPackage | PythonPackage;
// RPackage
// CondaPackage
...
export type Entrypoint = SoftwareEntrypoint | EnvironmentEntrypoint;
...
export class PackageInfo {
  ...
  public getPackage(id: string): PackageConfig {
    ...
    const crossplatform =
      artifact.crossplatform !== undefined
...
function binaryPackageFullName(
  crossplatform: boolean,
  name: string,
  version: string,
...
function binaryPackageAddressPattern(
  crossplatform: boolean,
  name: string,
  version: string
): string {
