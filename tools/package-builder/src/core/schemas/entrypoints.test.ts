...
test.for([
  {
    ...
    artType: "environment",
    variant: "minimal",
    data: testArtifacts.JavaEnvironmentEntrypoint,
  },
  {
    epTypes: ["environment"],
    artType: "environment",
    variant: "with reference",
    data: testArtifacts.JavaEnvironmentEntrypointWithReference,
  },
  { epTypes: ["asset"], artType: "asset", variant: "minimal", data: testArtifacts.AssetEntrypoint },
  {
    ...
    artType: "binary",
    variant: "minimal",
    data: testArtifacts.BinaryEntrypoint,
  },
  {
    epTypes: ["binary"],
    artType: "binary",
    variant: "with reference",
    data: testArtifacts.BinaryEntrypointWithReference,
  },
  {
    epTypes: ["binary"],
    artType: "binary",
    variant: "limited platforms",
    data: testArtifacts.LimitedPlatformsBinaryEntrypoint,
  },
  {
    epTypes: ["binary"],
    artType: "binary",
    variant: "version override",
    data: testArtifacts.CustomBinaryEntrypoint,
  },
  {
    epTypes: ["binary"],
    artType: "binary",
    variant: "version docker",
    data: testArtifacts.BinaryEntrypointWithDocker,
  },
  { epTypes: ["binary"], artType: "java", variant: "minimal", data: testArtifacts.JavaEntrypoint },
  {
    ...
    artType: "java",
    variant: "with reference",
    data: testArtifacts.JavaEntrypointWithReference,
  },
  {
    epTypes: ["binary", "docker"],
    artType: "java",
    variant: "with docker",
    data: testArtifacts.JavaEntrypointWithDocker,
  },
  {
    epTypes: ["binary"],
    artType: "python",
    variant: "minimal",
    data: testArtifacts.PythonEntrypoint,
  },
  {
    epTypes: ["binary"],
    artType: "python",
    variant: "with reference",
    data: testArtifacts.PythonEntrypointWithReference,
  },
  {
    epTypes: ["binary", "docker"],
    artType: "python",
    variant: "with docker",
    data: testArtifacts.PythonEntrypointWithDocker,
  },
  {
    epTypes: ["binary"],
    artType: "R",
    variant: "with reference",
    data: testArtifacts.REntrypointWithReference,
  },
  ...
  },
  {
    ...
    artType: "R",
    variant: "with docker",
    data: testArtifacts.REntrypointWithDocker,
  },
  { epTypes: ["conda"], artType: "conda", variant: "minimal", data: testArtifacts.CondaEntrypoint },
  {
    ...
    artType: "conda",
    variant: "with reference",
    data: testArtifacts.CondaEntrypointWithReference,
  },
  {
    epTypes: ["conda", "docker"],
    artType: "conda",
    variant: "with docker",
    data: testArtifacts.CondaEntrypointWithDocker,
  },
  {
    epTypes: ["docker"],
    artType: "docker",
    variant: "minimal",
    data: testArtifacts.DockerEntrypoint,
  },
  {
    epTypes: ["docker"],
    artType: "docker",
    variant: "with reference",
    data: testArtifacts.DockerEntrypointWithReference,
  },
