...
test('PackageInfo loads correctly for single binary package', () => {
  ...
  expect(i.artifactName(binary)).toEqual(testArtifacts.PackageNameNoAt + '/' + testArtifacts.EPNameBinary);
...
test('PackageInfo loads correctly for multi-package', () => {
  ...
  expect(registry.name).toEqual(testArtifacts.BinaryRegistry);
  expect(i.artifactName(environment)).toEqual(testArtifacts.PackageNameNoAt + '/' + testArtifacts.EPNameJavaEnvironment);
