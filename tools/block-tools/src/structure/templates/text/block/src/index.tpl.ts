...
import { platforma } from "${facadeName}.model";
import {
  InferOutputsType,
  InferDataType,
  InferHrefType,
...
export type ${pascalName}BlockContract = BlockContract;
export type ${pascalName}BlockOutputs  = BlockOutputs;
export type ${pascalName}BlockData     = BlockData;
export type ${pascalName}BlockHref     = BlockHref;
export const ${pascalName}BlockPointer = BlockPointer;
