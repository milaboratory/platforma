...
describe("simple traverse", () => {
  ...
  test.each([
    {
      roots: ["b2"],
      expectedDirectUpstreams: ["b1"],
      expectedDirectDownstreams: ["b6"],
      expectedUpstreams: ["b1"],
      expectedDownstreams: ["b6"],
    },
    {
      roots: ["b4"],
      expectedDirectUpstreams: ["b3"],
      expectedDirectDownstreams: ["b5", "b6"],
      expectedUpstreams: ["b3"],
      expectedDownstreams: ["b5", "b6"],
    },
    {
      roots: ["b5"],
      expectedDirectUpstreams: ["b3", "b4"],
      expectedDirectDownstreams: [],
      expectedUpstreams: ["b3", "b4"],
      expectedDownstreams: ["b6"],
    },
    {
      roots: ["b6"],
      expectedDirectUpstreams: ["b1", "b2", "b3", "b4"],
      expectedDirectDownstreams: [],
      expectedUpstreams: ["b1", "b2", "b3", "b4", "b5"],
      expectedDownstreams: [],
    },
  ])(
    "$roots",
