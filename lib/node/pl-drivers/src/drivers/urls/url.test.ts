...
describe("isFolderURL", () => {
  test("should return true for a valid URL", () => {
    const folderUrl =
      "plblob+folder://5976f110166cc5d8803c41181fbb708470b69075db19ad98d8971df350732028.31330_tgz.blob/path/to/folder";
...
describe("getPathForBlockUIURL", () => {
  ...
  test("should be ok with whitespaces", () => {
    const blockUIURL =
      "block-ui://signature.blockUIDir.uidir/path/to%20whitespaces%20/resource.html";
