...
// Sentinel registry/package name for placeholder descriptors, so an accidental execution fails
// with a recognizable error instead of an opaque registry 404.
export const NO_SOFTWARE_PLACEHOLDER = "no-software-placeholder";
