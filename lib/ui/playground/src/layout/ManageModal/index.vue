...
import { ManageModal } from '@milaboratory/platforma-uikit.lib';
...
const settings = computed<ManageModalTypes.ManageModalSettings<MySpec>>(() => {
  const settings: ManageModalTypes.ManageModalSettings<MySpec> = {
    title: 'Manage items',
    columnSettings: [
      {
        title: 'One title',
...
const onUpdate = (columns: ManageModalTypes.Column[]) => {
