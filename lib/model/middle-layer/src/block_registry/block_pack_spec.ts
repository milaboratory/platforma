...
export const BlockPackDevV1 = v.object({
  type: v.literal("dev-v1"),
  folder: v.string(),
  mtime: v.optional(v.string()),
});
/** @deprecated don't use */
export type BlockPackDevV1 = v.InferOutput<typeof BlockPackDevV1>;

/** Block pack from local folder, to be used during block development. New layout. */
export const BlockPackDevV2 = v.object({
  type: v.literal("dev-v2"),
  folder: v.string(),
  mtime: v.optional(v.string()),
});
export type BlockPackDevV2 = v.InferOutput<typeof BlockPackDevV2>;
 ...
 * `dev-v2`'s `folder`. */
export const BlockPackFromPackV2 = v.object({
  type: v.literal("from-pack-v2"),
  ...
  rootUrl: v.optional(v.string()),
  mtime: v.optional(v.string()),
});
export type BlockPackFromPackV2 = v.InferOutput<typeof BlockPackFromPackV2>;
 ...
 * @deprecated don't use
 * */
export const BlockPackFromRegistryV1 = v.object({
  type: v.literal("from-registry-v1"),
  registryUrl: v.string(),
  id: BlockPackId,
});
/** @deprecated don't use */
export type BlockPackFromRegistryV1 = v.InferOutput<typeof BlockPackFromRegistryV1>;

/** Block pack from registry with version 2 layout, to be loaded directly
 * from the client. */
export const BlockPackFromRegistryV2 = v.object({
  type: v.literal("from-registry-v2"),
  registryUrl: v.string(),
  id: BlockPackId,
  channel: v.optional(v.string()),
});
export type BlockPackFromRegistryV2 = v.InferOutput<typeof BlockPackFromRegistryV2>;

/** Information about block origin, can be used to instantiate new blocks */
export const BlockPackSpec = v.variant("type", [
  BlockPackDevV1,
  BlockPackDevV2,
  BlockPackFromPackV2,
...
export type BlockPackSpec = v.InferOutput<typeof BlockPackSpec>;
