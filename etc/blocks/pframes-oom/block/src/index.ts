...
import { platforma } from "@milaboratories/milaboratories.test-pframes-oom.model";
import {
  InferOutputsType,
  InferDataType,
  InferHrefType,
...
export type TestPframesOomBlockContract = BlockContract;
export type TestPframesOomBlockOutputs  = BlockOutputs;
export type TestPframesOomBlockData     = BlockData;
export const TestPframesOomBlockPointer = BlockPointer;
