...
export type PoolExplorerBlockContract = BlockContract;
export type PoolExplorerBlockOutputs  = BlockOutputs;
export type PoolExplorerBlockData     = BlockData;
export type PoolExplorerBlockHref     = BlockHref;
export const PoolExplorerBlockPointer = BlockPointer;
