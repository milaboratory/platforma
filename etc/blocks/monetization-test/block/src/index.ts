...
export type MonetizationTestBlockContract = BlockContract;
export type MonetizationTestBlockOutputs  = BlockOutputs;
export type MonetizationTestBlockData     = BlockData;
export type MonetizationTestBlockHref     = BlockHref;
export const MonetizationTestBlockPointer = BlockPointer;
