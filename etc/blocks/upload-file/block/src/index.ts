...
export type TestUploadFileBlockContract = BlockContract;
export type TestUploadFileBlockOutputs  = BlockOutputs;
export type TestUploadFileBlockData     = BlockData;
export type TestUploadFileBlockHref     = BlockHref;
export const TestUploadFileBlockPointer = BlockPointer;
