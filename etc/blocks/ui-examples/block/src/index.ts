...
export type UiExamplesBlockContract = BlockContract;
export type UiExamplesBlockOutputs  = BlockOutputs;
export type UiExamplesBlockData     = BlockData;
export type UiExamplesBlockHref     = BlockHref;
export const UiExamplesBlockPointer = BlockPointer;
