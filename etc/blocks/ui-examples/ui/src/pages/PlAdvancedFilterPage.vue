...
const uniqueValuesByAxisIdx: Record<string, Record<number, ListOptionBase<string>[]>> = {
  [column1Id]: {
    0: [
      { value: "axisValue1", label: "Axis Value 1" },
      { value: "axisValue2", label: "Axis Value 2" },
    ],
  },
};
...
const options: PlAdvancedFilterItem[] = [
  {
    ...
    spec: {
      ...
      name: "c1",
      axesSpec: [{ type: "String" as const, name: "nameAxis1" }],
    },
  },
  {
    id: column2Id,
...
watch(
  () => filterStates.value[selectedSavedFilters.value],
  (m) => {
