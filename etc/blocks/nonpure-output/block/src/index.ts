...
export type TestNonpureOutputBlockContract = BlockContract;
export type TestNonpureOutputBlockOutputs  = BlockOutputs;
export type TestNonpureOutputBlockData     = BlockData;
export const TestNonpureOutputBlockPointer = BlockPointer;
