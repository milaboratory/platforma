...
value: T;
  ...
  helper: {
    type: "?: string",
    description: "A helper text displayed below the component when there are no errors (optional).",
  },
  error: {
    type: "?: string",
    description: "Error message displayed below the component (optional)",
  },
};
