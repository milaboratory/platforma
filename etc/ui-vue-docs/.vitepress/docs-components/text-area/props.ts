export default {
  ...
  helper: {
    type: "?: string",
    description: "A helper text to display below the textarea when there are no errors.",
  },
  placeholder: {
    type: "?: string",
    description: "A placeholder text to display inside the textarea when it is empty.",
  },
  disabled: {
    type: "?: boolean",
