export default {
 ...
 Or you can pass a callback that returns null | undefined | string`,
  ...
  error: {
    type: "?: string",
    description: "An optional error message to display below the input field.",
  },
  helper: {
    type: "?: string",
    description: "A helper text to display below the input field when there are no errors.",
  },
  placeholder: {
    type: "?: string",
    description: "A placeholder text to display inside the input field when it is empty.",
  },
  disabled: {
    type: "?: boolean",
    description: "If `true`, the input field is disabled and cannot be interacted with.",
  },
  dashed: {
    type: "?: boolean",
  ...
  prefix: {
    type: "?: string",
    description: "A prefix text to display inside the input field before the value.",
  },
  rules: {
