...
or host. `hashDirSync` now sorts directory entries for that determinism (also affects
`--full-dir-hash` local descriptor hashes, which become stable across hosts).
